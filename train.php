...
<body>
    ...
    <div class="imgs" style="display: none;">
        ...
        <img id="bg" src="./asset/img/pop-up.jpeg"> 
    </div>
        <main>
            ...
            <canvas id="canvas" width="800" height="480" style="border: 1px solid black;">
                Hanoi game
            </canvas>    
            <div style="display:flex;">
            <div class="button"><button id="reset">Nouveau</button></div>
            <div class="button" style="margin-left: 100px;"><button id="demo">Demo</button></div>
            <div class="button" style="margin-left: 100px;"><a href = "./index.php" ><button>Retour</button></a></div>
            </div>
            
        </main>
        <script src="./confetti.js"></script>
        <script >
            let c_background = document.querySelector("#bg");
